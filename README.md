# CS241 — Database Management Systems Lab

Repository containing SQL assignments, relational database queries, JDBC applications, triggers, functions, and practical database implementations completed as part of the **CS241 Database Management Systems Lab** course at **Indian Institute of Information Technology Guwahati (IIITG)**.
...
This repository contains practical assignments and implementations related to relational database management systems, SQL querying, schema design, aggregation operations, nested queries, views, JDBC connectivity, SQL functions, triggers, and transaction-related database operations.
