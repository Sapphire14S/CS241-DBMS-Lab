...
-- Q1: Names and ages of all students
SELECT sname, age FROM Student;

-- Q2: Students older than 18
SELECT * FROM Student WHERE age > 18;

-- Q3: Serial numbers of students enrolled in Database Systems
SELECT snum FROM Enrolled WHERE cname = 'Database Systems';

-- Q4: Names of students enrolled in Database Systems
SELECT s.sname FROM Student s
JOIN Enrolled e
ON s.snum = e.snum
WHERE e.cname = 'Database Systems';

-- Q5: Faculty in department 20
